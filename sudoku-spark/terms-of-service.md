---
layout: default
title: Terms of Service - Sudoku Spark
...
Sudoku Spark is a mobile puzzle game application that provides:
- Sudoku puzzles at various difficulty levels (Easy, Intermediate, Advanced)
- Daily challenges
- Achievement tracking
- Game statistics
- Customizable themes and settings
- Optional rewarded advertisements for hints

## 3. User Eligibility

The App is available to users of all ages. There is no minimum age requirement as the App:
- Does not collect personal information
- Does not include user accounts
- Does not feature social interactions
- Does not display personalized advertisements
...
The App includes optional rewarded advertisements:
- You may watch ads to earn additional hints
- Watching ads is entirely voluntary
- Ad availability may vary based on your region and network
- We are not responsible for the content of third-party advertisements

## 8. Game Data

### Local Storage
Your game data is stored locally on your device. We are not responsible for data loss due to:
...
### Cloud Backup
If enabled, your game data may be backed up to Google Drive through Android's backup service. This is governed by Google's terms of service.
...
### Terms Changes
We reserve the right to modify these Terms at any time. Changes will be effective when posted. Continued use of the App after changes constitutes acceptance of the new Terms.
...
Any disputes arising from these Terms or the App shall be resolved through good faith communication. Please contact us with any concerns before taking formal action.
...
By using Sudoku Spark, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
